namespace EveMarket.Core.Repositories.Eve
{
    ...
    public partial class EveDb : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<industryActivityProbability>()
            ...
            modelBuilder.Entity<invMarketGroup>()
                .HasMany(e => e.childGroups)
                .WithOptional(e => e.parentGroup)
            ...
            modelBuilder.Entity<invType>()
                .HasMany(e => e.industryActivities)
                .WithRequired(e => e.invType)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.industryActivityMaterials)
                .WithRequired(e => e.type)
                .HasForeignKey(e => e.typeID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.industryActivityMaterials1)
                .WithRequired(e => e.materialType)
                .HasForeignKey(e => e.materialTypeID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.industryActivityProbabilities)
                .WithRequired(e => e.type)
                .HasForeignKey(e => e.typeID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.industryActivityProbabilities1)
                .WithRequired(e => e.productType)
                .HasForeignKey(e => e.productTypeID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.industryActivityProducts)
                .WithRequired(e => e.type)
                .HasForeignKey(e => e.typeID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.activityProducts)
                .WithRequired(e => e.productType)
                .HasForeignKey(e => e.productTypeID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.typeSkills)
                .WithRequired(e => e.type)
                .HasForeignKey(e => e.typeID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.activitySkills)
                .WithRequired(e => e.skillType)
                .HasForeignKey(e => e.skillID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<invType>()
                .HasOptional(e => e.industryBlueprint)
                .WithRequired(e => e.invType);

            modelBuilder.Entity<invType>()
                .HasMany(e => e.typeMaterials)
                .WithRequired(e => e.type)
                .HasForeignKey(e => e.typeID)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<staStation>()
                .HasRequired(s => s.mapSolarSystem)
                .WithMany(s => s.stations)
                .HasForeignKey(s => s.solarSystemID);

            modelBuilder.Entity<staStation>()
                .HasRequired(s => s.mapConstellation)
                .WithMany(s => s.stations)
                .HasForeignKey(s => s.constellationID);

            modelBuilder.Entity<staStation>()
                .HasRequired(s => s.mapRegion)
                .WithMany(s => s.stations)
